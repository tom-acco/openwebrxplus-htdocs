...
Shortcuts.handleKey = function(event) {
    ...
    // Leave CTRL+<LETTER> or COMMAND+<LETTER> (Mac) combinations to the browser
    if ((event.ctrlKey || event.metaKey) && event.key.match(/^[a-z]$/i)) return;
    ...
    switch (event.key.toLowerCase()) {
        ...
        case '6': case '7': case '8': case '9': case '0':
            ...
            n = n > 0? n - 1 : 9;
            if (event.ctrlKey || event.metaKey) n += 10;
