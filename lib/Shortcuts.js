    ...
    switch (event.key.toLowerCase()) {
        ...
        case 'arrowup':
            if (event.ctrlKey || event.metaKey) {
                ...
                $('#openwebrx-sdr-profiles-listbox option:selected').removeAttr('selected').prev().attr('selected', 'selected');
                sdr_profile_changed();
            }
            break;
        ...
        case 'arrowdown':
            if (event.ctrlKey || event.metaKey) {
                ...
                $('#openwebrx-sdr-profiles-listbox option:selected').removeAttr('selected').next().attr('selected', 'selected');
                sdr_profile_changed();
            }
            break;
